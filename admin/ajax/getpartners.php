...
<?php
  ...
  $query = "SELECT * FROM category WHERE status = 1".((!empty($_GET['search'])) ? (" AND name LIKE '%".$_GET['search']."%'") : (""))." LIMIT ".$_GET['offset'].",".$_GET['limit'];  
  ...
  $query2 = "SELECT count(id) as count FROM category WHERE status = 1"; 
